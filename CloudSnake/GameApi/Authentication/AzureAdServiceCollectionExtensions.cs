    ...
    public static class AzureAdServiceCollectionExtensions
    {
        ...
        private class ConfigureAzureOptions : IConfigureNamedOptions<JwtBearerOptions>
        {
            ...
            public void Configure(string name, JwtBearerOptions options)
            {
                ...
                options.Authority = $"{this.azureOptions.Instance}{this.azureOptions.TenantId}/v2.0/";
                ...
                options.TokenValidationParameters.IssuerValidator = this.ValidateIssuer;
            }
            ...
            private string ValidateIssuer(string issuer, SecurityToken securityToken, TokenValidationParameters validationParameters)
            {
                ...
                Uri authorityUri = new Uri(this.azureOptions.Instance);
